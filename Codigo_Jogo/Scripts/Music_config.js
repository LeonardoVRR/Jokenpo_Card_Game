...
btnMusica.addEventListener("click", ()=>{
    ...
    if (btnMusica.classList.contains("mudo")){
        btnMusica.children[0].setAttribute("src", "../SpriteBotoes/Prinbles_GUI_Asset_Silent (1.0.0)/asset/png@2x/Buttons/Square-Medium/SoundOff/Hover@2x.png")
        ...
        btnMusica.children[0].setAttribute("src", `../SpriteBotoes/Prinbles_GUI_Asset_Silent (1.0.0)/asset/png@2x/Buttons/Square-Medium/SoundOn/Hover@2x.png`)
...
btnMusica.addEventListener("mouseover", ()=>{
    btnMusica.children[0].setAttribute("src", `../SpriteBotoes/Prinbles_GUI_Asset_Silent (1.0.0)/asset/png@2x/Buttons/Square-Medium/Sound${music_Status}/Hover@2x.png`)
...
btnProxMusic.addEventListener("mouseover", ()=>{
    btnProxMusic.children[0].setAttribute("src", `../SpriteBotoes/Prinbles_GUI_Asset_Silent (1.0.0)/asset/png@2x/Buttons/Square-Medium/ArrowRight/Hover@2x.png`)
})

btnPrevMusic.addEventListener("mouseover", ()=>{
    btnPrevMusic.children[0].setAttribute("src", `../SpriteBotoes/Prinbles_GUI_Asset_Silent (1.0.0)/asset/png@2x/Buttons/Square-Medium/ArrowLeft/Hover@2x.png`)
})
...
controlesPlayerMusic.addEventListener("mouseover", (e)=>{
    ...
    if (btnPlayerAtivo.classList.contains("TelaJogo__btnMusica")){
        btnPlayerAtivo.addEventListener("mouseout", ()=>{
            btnPlayerAtivo.children[0].setAttribute("src", `../SpriteBotoes/Prinbles_GUI_Asset_Silent (1.0.0)/asset/png@2x/Buttons/Square-Medium/Sound${music_Status}/Default@2x.png`)
        })
        ...
        btnPlayerAtivo.addEventListener("mouseout", ()=>{
        btnPlayerAtivo.children[0].setAttribute("src", `../SpriteBotoes/Prinbles_GUI_Asset_Silent (1.0.0)/asset/png@2x/Buttons/Square-Medium/ArrowRight/Default@2x.png`)
        })
    }

    else {
        btnPlayerAtivo.addEventListener("mouseout", ()=>{
        btnPlayerAtivo.children[0].setAttribute("src", `../SpriteBotoes/Prinbles_GUI_Asset_Silent (1.0.0)/asset/png@2x/Buttons/Square-Medium/ArrowLeft/Default@2x.png`)
        })
    }
...
btnProxMusic.addEventListener("click", ()=>{
    ...
    btnMusica.children[0].setAttribute("src", `../SpriteBotoes/Prinbles_GUI_Asset_Silent (1.0.0)/asset/png@2x/Buttons/Square-Medium/Sound${music_Status}/Default@2x.png`)

    if (musicaAtualPlaylist_1 < 16 && musicaAtualPlaylist_2 === 0){
        playListAtual = 1

        musicaAtualPlaylist_1 += 1
        gameMusic.setAttribute("src", `../Music/music_pack_${playListAtual}/Stream Loops 2024 (${musicaAtualPlaylist_1}).ogg`)
    }
        ...
        if (musicaAtualPlaylist_2 < 9 && musicaAtualPlaylist_1 === 0){
            ...
            gameMusic.setAttribute("src", `../Music/music_pack_${playListAtual}/DavidKBD - Pink Bloom Pack - 0${musicaAtualPlaylist_2}.ogg`)
        }
