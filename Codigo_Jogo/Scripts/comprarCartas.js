...
function vericarCartasPlayer() {
    ...
    if (qtdCartasPlayer < 5){
        ...
        if (cartaAtiva === 1 && qtdCartasPlayer < 4) {
            ...
            cartaNovaImg.setAttribute("src", `../Cartas/${jokempo[gerarCartaAleatoria]}/card_${1}.png`)
            cartaNovaImg.setAttribute("alt", `../Cartas/${jokempo[gerarCartaAleatoria]}/card_${1}.png`)
...
function vericarCartasAdversario() {
    ...
    if (qtdCartasAdversario < 5){
        ...
        if (cartaAtiva === 1 && qtdCartasAdversario < 4) {
            ...
            let cartaNovaImg = document.createElement("img")
            cartaNovaImg.setAttribute("src", `../Carta (parte de tras)/carta_parte_de_tras.png`)
            cartaNovaImg.setAttribute("alt", `../Cartas/${jokempo[gerarCartaAleatoria]}/card_${1}.png`)
